            ...
            return (
              <Reveal key={item.index} delay={i * 0.08}>
                ...
                >
                  ...
                  <span className="font-display mt-4 block text-[0.8rem] font-semibold text-graphite">{item.index}</span>
                  <h3 className="font-display mt-1 text-[1.35rem] font-extrabold leading-tight">
